...
float BBQ10Keyboard::keyboardBrightness() const
{
    return readRegister8(_REG_BKL) / 255.0f;
}

void BBQ10Keyboard::setKeyboardBrightness(float value)
{
    writeRegister(_REG_BKL, value * 255);
}

float BBQ10Keyboard::displayBrightness() const
{
    return readRegister8(_REG_BK2) / 255.0f;
}

void BBQ10Keyboard::setDisplayBrightness(float value)
{
